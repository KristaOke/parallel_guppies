...
data<- read.csv(paste(wd,'/Data/Data.csv',sep=""), header=TRUE, sep=",")%>% #Data.csv is saved straight from .xlsx
...
#write_csv(slope.data, path = "~/Documents/Masters/R scripts/Meta Analysis/Data/MetaData.csv") #written dec 2nd
```

gonna create a loop to determine the ratio of north to south within weach trait
