...
South<-c("Tunapuna", "Lopinot", "Guanapo", "Aripo", "Cuara", "Tranquille", "Caroni", "Arima", "Arouca", "Mausica", "Tacarigua", "El Cedro", "Ceniza", "Naranjo", "Maracas", "Caroni Lower Dyke", "Caura", "Manacal", "Quare","Hollis", "Oropuche", "Turure", "La Seiva", "Rio Barro", "Rio Grande", "La Selva", "Valencia", "Matura", "Hollis", "Saint Joseph", "Caura", "Oropuna")  
...
map_other<-c("Pilote", "Lizard", "Guapo", "Coffee", "Silverstream", "Arena", "Vance", "Mayaro", "Cunupia Lower Dyke", "Manzanilla", "Visigney", "Tompire", "Ricon", "Mission", "Toco")
map_aripo<-c("Aripo", "Ceniza", "Naranjo", "Valencia")
map_quare<-c("Quare","Hollis")
map_tunapuna<-c("Tunapuna", "Caroni Lower Dyke")
map_tacarigua<-c("Tacarigua", "Cuara")
...
#changing intro sites, El cedro LP is intro, El Cedro HP is natural
new.data$Poptype_broad<-ifelse(new.data$Population %in% c("Damier", "Turure"), "Introduction", new.data$Poptype)
new.data$Poptype_broad<-ifelse((new.data$Population %in% c("El Cedro") & new.data$Predation=="Low"), "Introduction", new.data$Poptype)
