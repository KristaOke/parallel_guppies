...
ggplot((all_dat %>% 
         filter(!StudyID == 22) %>% 
          filter(StudyID == c(15,9,32))), aes(Number, R.2, color = as.factor(StudyID))) + geom_point()
ggplot((all_dat %>% 
         filter(!(StudyID == 22|StudyID ==20))), aes(Number, R.2, color = as.factor(StudyID))) + geom_point()

ggplot((all_dat %>% 
         filter(!(StudyID == 22|StudyID ==20))), aes(Number, R.2, color = as.factor(Published))) + geom_point()
