...
#setwd("<YOURPATHWAY>")
wd <- getwd()
data<- read.csv(paste(wd,'/Data/MetaData.csv',sep=""), header=TRUE, sep=",")%>% #MetaData saved oct 27th
...
#write_csv(new.data, path = "~/Documents/Masters/R scripts/Meta Analysis/data/MetaData.csv") #written oct 27
