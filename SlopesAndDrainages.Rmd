...
data<- read.csv(paste(wd,'/Data/Data_final.csv',sep=""), header=TRUE, sep=",")%>% #Data.csv is saved straight from .xlsx feb 25th
...
data$Kingsolver_traits<-ifelse(data$TraitID %in% c(41:42,62:79,81:82,89:91,119:121,295:297,301:303,554), "Physiology", 
                               ifelse(data$TraitID %in% c(27:28,33:34,377,472), "Other_life_history",
                               ifelse(data$TraitID %in% c(471,473), "Other_morphology", data$Kingsolver_traits)))
...
#write_csv(slope.data, path = "~/Documents/Masters/R scripts/Meta Analysis/Data/MetaData.csv") #written feb 25th
```
