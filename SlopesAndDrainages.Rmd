...
##Rdat_intros_broad<-full_output(dat = output_intros_broad, resampleDat = resample_intros_broad)# error
#write.table(Rdat_intros, file = "Resample_intro_broad.csv",row.names=FALSE,col.names=TRUE, sep=",") 
```


```{r intros_broad troubleshoot}
...
>>>>>>> cf3c60a122d0e3d7b30d6020f91710e0b5305eb7
```{r visualization}
# for all the traits
